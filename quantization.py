...
# Quantized signal with truncation (dithering: high-pass)
plt.subplot(4, 2, 8)
plt.plot(t, quantized_signal_truncation_dither_hp, label='Quantized Signal (Truncation, Dither: High-Pass)')
plt.title('Quantized Signal with Truncation (Dither: High-Pass)')
plt.xlabel('Sample Index')
plt.ylabel('Amplitude')
plt.legend()
